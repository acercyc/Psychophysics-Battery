function kbNameResult = KbName_acer(arg)
%======================================================================%
% Attention !! Modify by Acer for left_alt and right_alt
% 1.0 - Acer 2011/06/09_15:57
%======================================================================%
...
if isempty(kkOSX)
   ...
   kkWin{164} = 'left_alt'; % add by Acer
   kkWin{165} = 'right_alt'; % add by Acer
   kkWin{91} = 'left_menu';
   kkWin{92} = 'right_menu';
